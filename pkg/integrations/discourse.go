...
func (s *DiscourseIntegration) Pull(ctx context.Context, sub *models.Subscription) error {
...
func (s *DiscourseIntegration) Push(ctx context.Context, r *http.Request, body []byte) error {
...
func (a *DiscourseIntegration) ProcessRawData(ctx context.Context, tenantID string, data []byte) (*models.Feedback, error) {
	...
	if err := json.Unmarshal(data, &intercomData); err != nil {
		return nil, fmt.Errorf("failed to unmarshal Discourse data: %v", err)
	}
...
func (a *DiscourseIntegration) GetSourceName() string {
	return "Discourse"
}
